		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "customers",
									"targetURL": "#comproycustomers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comproycustomers-display": {
								"semanticObject": "comproycustomers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.proy.customers",
									"url": sap.ui.require.toUrl("com/proy/customers")
								}
							}
						}
					}
